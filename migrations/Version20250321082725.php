 ...
 */
final class Version20250321082725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation CHANGE statut statut VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation CHANGE statut statut VARCHAR(20) DEFAULT NULL');
